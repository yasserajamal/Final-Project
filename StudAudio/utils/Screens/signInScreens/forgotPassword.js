...
const ForgotPassword = () => {
  ...
  const ifSendPressed = async () => {
    try {
      ...
      alert(
        "If your email address is registered in our system, you will receive a password reset link shortly. Please check your inbox and follow the instructions to reset your password"
      );
