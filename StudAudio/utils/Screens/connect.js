...
const Data = [
    { id: '1', name: 'Michael', bio: 'Dad, Husband, Tech Founder' ,info: "Also taking: CS157", 
    image:require("../../assets/Connect/Michael.jpg")

    },
    { id: '2', name: 'Daniela', bio: 'Public Health Student :)',  
    image: require("../../assets/Connect/Daniela.jpg")

    },

    { id: '3', name: 'Emmanuel', bio: 'Software Engineer going back to school',  
    image:require("../../assets/Connect/Emmanuel.jpg") 

    },

    { id: '4', name: 'Rica', bio: "I'm passionate about envionrmental sceince" , info: "Also taking: PHIL 180" ,
     image:require("../../assets/Connect/Rica.jpg")

    }, 

    { id: '5', name: 'Eric', bio: 'Educator diving into ed-tech' ,info: "Also taking: CS 157, MATH 51 ", 
  ...
  const navigation = useNavigation();
    return (
      <View style={styles.container}>
        ...
        <Text style={styles.instructionText}>Swipe right to connect, left to skip</Text>
        {!remainingConnections && (
        <Text style={styles.noConnectionsLeftText}>
    Looks like you've seen everyone who wants to connect,  
    check back soon for new connections 
        ...
        stackSize={3} 
      />
       <TouchableOpacity onPress={ViewConnections} style={styles.viewConnectionsButton}>
